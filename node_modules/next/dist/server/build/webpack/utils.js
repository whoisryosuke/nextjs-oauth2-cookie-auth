...
var nextPagesDir = _path.default.join(__dirname, '..', '..', '..', 'pages');
...
function _getPages() {
  ...
  _regenerator.default.mark(function _callee(dir, _ref) {
    var dev, isServer, pageExtensions, pageFiles;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            dev = _ref.dev, isServer = _ref.isServer, pageExtensions = _ref.pageExtensions;
            _context.next = 3;
